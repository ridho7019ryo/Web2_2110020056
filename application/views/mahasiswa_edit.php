            ...
            <div class="col-md-6">
                <div class="form-container">
                    <div class="school-theme text-center">
                        <span class="header-text">FORM EDIT MAHASISWA</span>
                    </div>
                    <form action='<?= site_url('mahasiswa/perbaharui/'.$mahasiswa->id_mahasiswa) ?>' method='post'>
                        <div class="form-group">
                            <label for="NIM">NIM</label>
                            <input type="text" name="NIM" value="<?php echo $mahasiswa->NIM ?>" id="NIM" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="nama_mhs">Nama Mahasiswa</label>
                            <input type="text" name="nama_mhs" value="<?php echo $mahasiswa->nama_mhs ?>"  id="nama_mhs" class="form-control" required>
                        </div>
                        <div class="form-group">
